...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden pt-20 pb-24 sm:pt-28 sm:pb-32">
      ...
      <div
        aria-hidden
        className="bg-dot-grid pointer-events-none absolute inset-0 -z-10 opacity-[0.05]"
      />

      <motion.div
        aria-hidden
        className="pointer-events-none absolute top-28 left-[8%] hidden rounded-2xl bg-surface p-3 shadow-lg shadow-ink/5 sm:block"
      ...
      >
        <Package className="h-6 w-6 text-lavender-dark" strokeWidth={1.75} />
      </motion.div>
      <motion.div
        aria-hidden
        className="pointer-events-none absolute top-40 right-[10%] hidden rounded-2xl bg-surface p-3 shadow-lg shadow-ink/5 sm:block"
        initial={{ opacity: 0, y: 0, rotate: 8 }}
        animate={{ opacity: 1, y: [0, 10, 0], rotate: 8 }}
        transition={{
      ...
      >
        <MapPinned className="h-6 w-6 text-pink-dark" strokeWidth={1.75} />
      </motion.div>
